...
package flash_program is
   ...
   procedure default_flash_handler (
      file : in out Unbounded_String; address : in out Unbounded_String);
   procedure flash_handler (
      file : Unbounded_String; address : Unbounded_String);
   procedure flash (
      file : Unbounded_String; address : Unbounded_String);
end flash_program;